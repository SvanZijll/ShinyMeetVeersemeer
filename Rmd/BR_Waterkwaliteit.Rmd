...
In de periode `r beginjaar` - `r eindjaar` nam de fosfaat concentratie nam toe met ongeveer 0.2 mg P/jaar (zie figuur).
...
In de periode `r beginjaar` - `r eindjaar` nam de nitraat concentratie af met ongeveer 1 mg N/jaar (zie figuur). 
...
In de periode `r beginjaar` - `r eindjaar` nam de silicaat concentratie af met 0.5 mg Si/jaar (zie figuur). 
